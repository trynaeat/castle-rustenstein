...
pub fn gen_textures (tex_width: u32, tex_height: u32) -> [[[u32; 64]; 64]; 8] {
    ...
    for x in 0..tex_width {
        for y in 0..tex_height {
            ...
            textures[0][y as usize][x as usize] = 65536 * 254 * ((x != y && x != tex_width - y) as u32); //flat red texture with black cross
            ...
            textures[5][y as usize][x as usize] = 65536 * 192 * ((x % 16 == 0) && (y % 16 == 0)) as u32; //red bricks
            textures[6][y as usize][x as usize] = 65536 * ycolor; //red gradient
            textures[7][y as usize][x as usize] = 128 + 256 * 128 + 65536 * 128; //flat grey texture
        }
    }
